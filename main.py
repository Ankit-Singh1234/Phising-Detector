...
# os.environ["GOOGLE_API_KEY"] = "AIzaSyBP1AfahiQSbBTnaG3tSFsbAusgpV00KVM"
#genai.configure(api_key=os.environ["AIzaSyBP1AfahiQSbBTnaG3tSFsbAusgpV00KVM"])
genai.configure(api_key="AIzaSyBP1AfahiQSbBTnaG3tSFsbAusgpV00KVM")
